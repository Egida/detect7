...
class EngineConfig:
    ...
    # DOMAIN LOGS RABBITMQ SETTINGS (syslog -> SaaS DB writer)
    RABBITMQ_DOMAIN_LOGS_EXCHANGE = os.getenv('RABBITMQ_DOMAIN_LOGS_EXCHANGE', 'detect7.domain_logs')
    RABBITMQ_DOMAIN_LOGS_QUEUE = os.getenv('RABBITMQ_DOMAIN_LOGS_QUEUE', 'domain_logs')
    RABBITMQ_DOMAIN_LOGS_ROUTING_KEY = os.getenv('RABBITMQ_DOMAIN_LOGS_ROUTING_KEY', 'domain_logs')

    # DETECTIONS RABBITMQ SETTINGS (ML worker -> SaaS DB writer)
    RABBITMQ_DETECTIONS_EXCHANGE = os.getenv('RABBITMQ_DETECTIONS_EXCHANGE', 'detect7.detections')
    RABBITMQ_DETECTIONS_QUEUE = os.getenv('RABBITMQ_DETECTIONS_QUEUE', 'detections')
    RABBITMQ_DETECTIONS_ROUTING_KEY = os.getenv('RABBITMQ_DETECTIONS_ROUTING_KEY', 'detections')

    # REDIS API KEY CACHE SETTINGS
    REDIS_APIKEY_PREFIX = os.getenv('REDIS_APIKEY_PREFIX', 'dk7:key')
    REDIS_APIKEY_RPS_PREFIX = os.getenv('REDIS_APIKEY_RPS_PREFIX', 'dk7:rps')
    REDIS_APIKEY_SERVER = os.getenv('REDIS_APIKEY_SERVER', os.getenv('REDIS_TS_SERVER', 'localhost'))
    REDIS_APIKEY_PORT = int(os.getenv('REDIS_APIKEY_PORT', os.getenv('REDIS_TS_PORT', 6379)))
    REDIS_APIKEY_USER = os.getenv('REDIS_APIKEY_USER', os.getenv('REDIS_TS_USER', ''))
    REDIS_APIKEY_PASS = os.getenv('REDIS_APIKEY_PASS', os.getenv('REDIS_TS_PASS', ''))
    REDIS_APIKEY_DB = int(os.getenv('REDIS_APIKEY_DB', 2))
